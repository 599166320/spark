    ...
    public static void main(String[] args) {
        ...
        JavaPairRDD<Integer, String> pairRdd = jsc.parallelizePairs(
                Arrays.asList(
                        ...
                        new Tuple2<Integer, String>(7, "G"),
                        new Tuple2<Integer, String>(7, "G"),
                        new Tuple2<Integer, String>(8, "H")),

                3);
        RDD<Tuple2<Integer, String>> rdd = JavaPairRDD.toRDD(pairRdd);

        //System.out.println(pairRdd.getNumPartitions());
        //JavaPairRDD<Integer, String> hashPartitioned = pairRdd.partitionBy(new HashPartitioner(4));
//
